...
export const tutors: Tutor[] = [
  {
    ...
    pass_count: 23,
    tutor_type: "korean",
    age_bands: ["elementary", "grade4plus"],
    lesson_modes: ["visit"],
  ...
  // ── 원어민 튜터 (유아·초등 영어 튜터링 라인업) ─────────────────
  {
    id: "tu_native_1",
    name: "Emily",
    bio: "유아 영어 몰입 수업 전문. 놀이와 파닉스로 자연스럽게 영어에 흥미를 붙여줍니다.",
    regions: ["서초", "강남", "반포"],
    subjects: ["Phonics", "Speaking", "Story Reading", "유치원 Prep"],
    academy_slugs: [],
    base_rate: 90000,
    rating_avg: 4.9,
    response_rate: 0.97,
  ...
  },
  {
    id: "tu_native_2",
    name: "Michael",
    bio: "초등 영어 리딩·라이팅 기초부터 학교 영어까지 체계적으로 지도합니다.",
    regions: ["목동", "마포"],
    subjects: ["Reading", "Writing", "Grammar", "School English"],
    academy_slugs: [],
    base_rate: 95000,
    rating_avg: 4.8,
    response_rate: 0.94,
  ...
  },
  {
    id: "tu_native_3",
    name: "Jenny",
    bio: "만 2~5세 놀이 영어 전문. 소리와 리듬으로 영어 노출을 시작합니다.",
    regions: ["온라인"],
    subjects: ["Speaking", "Vocabulary", "놀이 영어"],
    academy_slugs: [],
    base_rate: 75000,
    rating_avg: 4.9,
    response_rate: 0.99,
